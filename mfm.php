...
$file_root = 'media'; 		//where to store files, must be created and writable
$root_path = THISURL .PATH; 					//path from webroot, without trailing slash. If your page is located in http://www.example.com/john/, this should be '/john'
